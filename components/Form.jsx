        ...
        <div className="flex flex-col max-w-[526px] mt-4 mb-4 w-full mx-auto">
          ...
          <div className="w-full lg:w-full flex flex-col items-center mx-auto">
            <div className="relative w-[90%] lg:w-full flex justify-center">
              ...
              <input
                required
                className={`pl-10 w-full h-[35px] rounded-[8px] border-[1px] ${
            ...
            <div className="relative w-[90%] lg:w-full flex justify-center mt-4">
              ...
              <input
                className="pl-10 w-full h-[35px] rounded-[8px] border-[1px] border-[#DADCE0] mx-auto"
                type="number"
                required
                id="contact-phone"
        ...
        <div className="flex mb-2 flex-col max-w-[526px] w-full mx-auto">
          ...
          <div className="flex justify-center items-center gap-2  w-[90%] lg:w-full mx-auto">
            <input
              ...
              max="31"
              placeholder="DD"
              className="w-[32%] lg:w-[170px] pl-2 h-[35px] rounded-[8px] border-[1px] border-[#DADCE0]"
            />
            <input
              type="number"
              id="dob-month"
            ...
            <div className="flex flex-col w-full">
              <div className="flex lg:gap-10 gap-4">
                <input
                  ...
                  className="max-w-[404px] w-[100%] md:w-[350px] lg:w-[380px] pl-2 h-[35px] rounded-[8px] border-[1px] border-[#DADCE0]"
                />
                <button
                  type="button"
